...
function questionChoiceCat_3_1() {
    ...
    questChoiceCatLoad.questionBlock('Отбор', 'Женщины космонавты. Позывные.', 'У этой женщины-космонавта позывной названия морской птицы.', 'Светлана Савицкая - «Альбатрос»', 'Валентина Терешкова – «Чайка»', 'Елена Серова – «Буревестник»');
...
function questionChoiceCat_3_2() {
    ...
    questChoiceCatLoad.questionBlock('Отбор', 'Женщины космонавты. Позывные.', 'Позывной этой женщины космонавта носит название третьей по длине реки после Волги и Дуная', 'Светлана Савицкая - «Днепр»', 'Светлана Савицкая - «Днестр»', 'Светлана Савицкая - «Днепр – 3»');
    ...
    for (let i = 0; i < answerVarRight_3_2.length; i++) {
        if (answerVarRight_3_2[i] === answerVarRight_3_2[answerWrightNum]) {
            answerVarRight_3_2[i].addEventListener('click', () => {
                ...
                localStorage.setItem('progressChoiceQuest_2', JSON.stringify(progressChoiceQuestSum_3));
...
function questionChoiceCat_3_3() {
    ...
    questChoiceCatLoad.questionBlock('Отбор', 'Женщины космонавты. Позывные.', 'Позывной следующего женщины – название мастера кузнечного дела в Бурятии', 'Елена Серова – «Мастер»', 'Елена Серова – «Тархан»', 'Елена Серова – «Тандыр»');
